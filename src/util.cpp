...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "GoldCoinUnlimited";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/GoldCoinUnlimited";
#else
    // Unix
    return pathRet / ".GoldCoinUnlimited";
#endif
#endif
}
